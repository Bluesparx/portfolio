    ...
    <div className="project-div lg:px-40 lg:py-10 sm:px-10">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {projects.map((project, index) => (
          <div key={index} className="Gcard drop-shadow-md relative flex items-center justify-center rounded-lg bg-white p-6 shadow">
            <div className="flex flex-col text-start align-top">
              <h2 className="text-xl font-bold tracking-tight text-gray-800 mb-4">{project.title}</h2>
