...
const Header = () => {
    ...
    const toggleMode = () => {
        ...
        if (newMode === 'dark') {
            rootElement.style.backgroundColor = '#3B3030'; 
        } else {
            rootElement.style.backgroundColor = '#f1d7de';
        }
    ...
    useEffect(() => {
        ...
        if (savedMode) {
            ...
            const rootElement = document.getElementById('root');
            rootElement.style.backgroundColor = savedMode === 'dark' ? '#3B3030' : '#f1d7de';
        } else {
            ...
            const rootElement = document.getElementById('root');
            rootElement.style.backgroundColor = defaultMode === 'dark' ? '#3B3030' : '#f1d7de';
